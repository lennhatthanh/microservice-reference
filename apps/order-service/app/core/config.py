...
class Settings:
    ...
    PRODUCT_SERVICE_URL = get_required_env("PRODUCT_SERVICE_URL")
    PAYMENT_SERVICE_URL = get_required_env("PAYMENT_SERVICE_URL")
    NOTIFICATION_SERVICE_URL = get_env("NOTIFICATION_SERVICE_URL", "")
